...
class Board:
    ...
    def get_reward(self, game_over):
        ...
        if game_over and int(self.state_t.replace('0','')) == 1:
            ...
            return variables.terminal_state_penalty #(variables.board_size**2 - variables.terminal_state_penalty * len(self.state_t.replace('0','')))*  variables.terminal_state_penalty/10
